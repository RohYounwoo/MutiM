   ...
   while True:
        ...
        if ret:
            ...
            if temptxt:
                ...
                if h > 1179:
                    h = 1179
                for yRange in range(30, 30 + h):
                    for xRange in range(100, 100 + h):
                        #print(frame[xRange][yRange])
                        frame[xRange][yRange] -= 70
                        print(frame[xRange][yRange])
                        #frame[xRange][yRange][1] -= 70
                        #frame[xRange][yRange][2] -= 70
